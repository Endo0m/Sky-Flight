...
public class WebViewManager : MonoBehaviour
{
    ...
    [SerializeField] private string termsOfUseUrl = "https://www.google.com";
    [SerializeField] private string feedbackUrl = "https://www.google.com";

    public void OpenPrivacyPolicy()
    {
        ShowUrlFullScreen(privacyPolicyUrl);
    }

    public void OpenTermsOfUse()
    {
        ShowUrlFullScreen(termsOfUseUrl);
    }

    public void OpenFeedback()
    {
        ShowUrlFullScreen(feedbackUrl);
    }
